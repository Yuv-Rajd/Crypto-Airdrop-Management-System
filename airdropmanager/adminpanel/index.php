...
<body>
    ...
    <?php
                                       include "connect.php";
                                       $sql="select ID from airdrops order by ID;";
                                    ...
                                    ?>
                                       <?php
                                       include "connect.php";
                                       $sql1="select ID from participants order by ID;";
                                       $result1=mysqli_query($con,$sql1);
                                       $num1=mysqli_num_rows($result1);
                                      ?>
                                       <?php
                                      include "connect.php";
                                      $sql2="select ID from joined_in order by ID;";
                                      ...
                                      ?>
                                       <?php
                                       include "connect.php";
                                      $sql3="select ID from support_enquiry order by ID;";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 style="s" class="fs-2 m-0">Crypto airdrops</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                ...
                                <p class="fs-5">Airdroops</p>
                            </div>
                            <i class="fas fa-parachute-box  fs-1 primary-text border rounded-full secondary-bg p-3"></i>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><?php echo $num1; ?></h3>
                                <p class="fs-5">Members</p>
                            </div>
                            <i
                                class="fas fa-user-friends  fs-1 primary-text border rounded-full secondary-bg p-3"></i>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><?php echo $num2; ?></h3>
                                <p class="fs-5">Claims</p>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2"><?php echo $num3; ?></h3>
