...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Frequently Asked Question</h3>
                    <div class="col">
  ...
  <div class="form-row">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" placeholder="ANSWER" name="ANSWER" value="Lorem ipsum dolor sit amet, 
...
<?php
 ...
 // $name=$_POST[''];
    ...
    $ans=$_POST['ANSWER'];
    $sql="INSERT INTO faq VALUES(NULL,'$quest','$ans');";
