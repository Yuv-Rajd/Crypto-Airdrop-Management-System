    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="participants.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Subscribed Members</h3>
                    <div class="col">
                                       ...
                                       if($result){
                                          while($row=mysqli_fetch_assoc($result)){
                                            ...
                                            echo '<tr> 
                                                ...
                                                class="btn btn-primary"><a style="text-decoration:none"href="pdetail.php?email='.$pemail.'"
                                                class="text-light">View</a></button>
                                                </tr>';
                                               
                                                // <button  style="background-color:red" 
                                                // class="btn btn-primary" onclick="myFunction()" ><a style="text-decoration:none" href="Remove.php?email='.$pemail.'"
                ...
                // class="text-light">join</a></button>' ;<button onclick="myFunction()">Try it</button>
