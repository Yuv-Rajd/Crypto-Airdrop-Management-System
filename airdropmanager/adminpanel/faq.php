    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="faq.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i
        ...
        <div class="container-fluid px-4">
            ...
            <div class="row my-5">
                <h3 class="fs-4 mb-3">Frequently Asked Question</h3><br>
                <button  style="background-color:black" class="btn btn-primary"><a style="text-decoration:none" href="addfaq.php"  class="text-light">ADD</a></button><br>
                <div class="col">
                            ...
                            <?php
                                       ...
                                       if($result){
                                          while($row=mysqli_fetch_assoc($result)){
                                            ...
                                            class="btn btn-primary" onclick="myFunction()"><a style="text-decoration:none" href="removefaq.php?quest='.$quest.'"
                                            class="text-light">Remove</a></button></td>
                                             </tr>';
                                        }}
 ?>
